...
lm1_robust_check <- lm(SCDBradSelfReport1_mean ~ anxcond + storycond + ideology + age + race + income + education, data = noRelaxCond)

lm2_robust_check <- lm(immigration ~ anxcond + storycond + SCDBradSelfReport1_mean + ideology + age + race + income + education, data = noRelaxCond)
