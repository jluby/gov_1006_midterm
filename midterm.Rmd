...
plot(m.out, labels=c("ACME\n(Physiological \nReactivity)", "Direct Effect \n(Anxiety)", "Total Effect"), main = "Anxiety Conditions Affect Immigration Stance \nThrough Physiological Activation")
```
...
star <- stargazer(inter_1, inter_2, inter_3, 
          omit.stat = c("adj.rsq","ll", "F", "ser"),
